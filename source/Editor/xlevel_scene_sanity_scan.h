#ifndef XLVL_NEW_LevelEditor_SCENE_SANITY_SCAN_H
#define XLVL_NEW_LevelEditor_SCENE_SANITY_SCAN_H
#pragma once
...
//
// Included after LevelEditor_CommandContext.h (query_command_base for RunSanityCheck) and LevelEditor_EditorState.h (level_context).
    ...
    struct run_sanity_check_query_cmd : xlevel::commands::level_query_command
    {
        ...
        std::string Query() noexcept override
        {
            ...
            for (auto& SceneGuid : OpenScenes)
                xlevel::LaunchSceneSanityScan(World(), SceneGuid);
...
#endif // XLVL_NEW_LevelEditor_SCENE_SANITY_SCAN_H
