#ifndef XLVL_NEW_LevelEditor_EDITOR_TABS_H
#define XLVL_NEW_LevelEditor_EDITOR_TABS_H
#pragma once
#include <utility>
...
namespace xlevel::editor_tabs
{

    // Display name is filled each frame; ### id must stay fixed for focus/dock.
    inline constexpr char kLevelEditorWindowId[] = "LevelEditor";
        ...
        bool* pOpen = nullptr) noexcept
    {
        ...
        // Title is "Name###LevelEditor" ??? stable id; normal theme tab/menu sizes.
...
#endif // XLVL_NEW_LevelEditor_EDITOR_TABS_H
