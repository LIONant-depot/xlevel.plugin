#ifndef XLEVEL_COMMANDS_LEVEL_H
#define XLEVEL_COMMANDS_LEVEL_H
#pragma once
...
namespace xlevel::commands
{
    ...
    struct audit_component_usage_query_cmd : level_query_command
    {
        audit_component_usage_query_cmd(xundo::system& System, void* pDataBase) noexcept : level_query_command(System, "AuditComponentUsage", pDataBase) {}
        const char* getCommandHelp() const noexcept override
        {
    ...
    //================================================================================================
    // CloseScene - wraps the existing xlevel::CloseScene helper (xlevel_editor.h): releases one
    ...
    //================================================================================================
    struct close_scene_cmd : level_query_command
    {
        close_scene_cmd(xundo::system& System, void* pDataBase) noexcept : level_query_command(System, "CloseScene", pDataBase) { RegisterArguments(); }
        const char* getCommandHelp() const noexcept override
        {
    ...
    //================================================================================================
    struct list_scenes_query_cmd : level_query_command
    {
        list_scenes_query_cmd(xundo::system& System, void* pDataBase) noexcept : level_query_command(System, "ListScenes", pDataBase) { RegisterArguments(); }
    ...
    // uses (xlevel_panel_level_tree.h).
    //================================================================================================
    struct list_entities_query_cmd : level_query_command
    {
        list_entities_query_cmd(xundo::system& System, void* pDataBase) noexcept : level_query_command(System, "ListEntities", pDataBase) { RegisterArguments(); }
    ...
    //================================================================================================
    struct list_folders_query_cmd : level_query_command
    {
        list_folders_query_cmd(xundo::system& System, void* pDataBase) noexcept : level_query_command(System, "ListFolders", pDataBase) { RegisterArguments(); }
...
//================================================================================================
struct add_scene_cmd : level_command
{
    add_scene_cmd(xundo::system& System, void* pDataBase) noexcept : level_command(System, "AddScene", pDataBase) { RegisterArguments(); }
    const char* getCommandHelp() const noexcept override
    {
...
//================================================================================================
struct remove_scene_cmd : level_command
{
    remove_scene_cmd(xundo::system& System, void* pDataBase) noexcept : level_command(System, "RemoveScene", pDataBase) { RegisterArguments(); }
    const char* getCommandHelp() const noexcept override
    {
